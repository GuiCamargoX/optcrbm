...
"""Train the CRBM on the Semeion dataset."""
...
from optcrbm import CRBM, Trainer, load_semeion  # noqa: E402
...
def train():
    ...
    train_tensor, test_tensor = load_semeion(model["btmup_window_shape"], model["block_shape"])
