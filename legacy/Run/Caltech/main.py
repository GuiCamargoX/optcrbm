...
"""Train the CRBM on Caltech 101 Silhouettes."""
...
from optcrbm import CRBM, Trainer, load_caltech  # noqa: E402
...
def train():
    ...
    train_tensor, test_tensor = load_caltech(model["btmup_window_shape"], model["block_shape"])
