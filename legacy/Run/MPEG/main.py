...
"""Train the CRBM on the MPEG dataset."""
...
from optcrbm import CRBM, Trainer, load_mpeg  # noqa: E402
...
def train():
    ...
    train_tensor, test_tensor = load_mpeg(model["btmup_window_shape"], model["block_shape"])
